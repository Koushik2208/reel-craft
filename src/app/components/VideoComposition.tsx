...
export type CompositionProps = VideoProps & { template: TemplateId; frameId?: FrameId };
...
//
// `children` (cinematic finish overlays) render alongside the template
// output *inside* the frame wrapper, so grain/vignette/letterbox are part of
// the framed scene rather than floating on top of the device shell.
